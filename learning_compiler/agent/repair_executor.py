...
def _compact_curriculum_for_llm(curriculum: dict[str, Any]) -> dict[str, Any]:
    ...
    open_questions = curriculum.get("open_questions")
        ...
        response = self._client.run_json(
            LLMRequest(
                ...
                payload={
                    ...
                    "current_curriculum": _compact_curriculum_for_llm(patched),
